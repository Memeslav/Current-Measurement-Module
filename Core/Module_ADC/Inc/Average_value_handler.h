...
static inline void 		Average_handler_reset		(Average_value_handler_t *buffer)					{  *buffer = (Average_value_handler_t){0};}
...
static inline uint16_t 	Average_handler_get_average	(const Average_value_handler_t *buffer)
{
